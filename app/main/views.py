...
def index():
    if "user" in session:
        ...
        user = "Login"
    lg=get_locale()
    return render_template('index.html', user=user, lg=lg, ret="Important: This is the <a href='/tls/'>TLS version</a> of the website.  Go to <a href='https://www.kanripo.org'>www.kanripo.org</a> for the regular one.")
